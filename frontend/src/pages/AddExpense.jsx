      ...
      <div className="flex h-[80vh] items-center justify-center relative">
        ...
        <div ref={successRef} className="text-center space-y-10 relative z-10 glass-card p-16 rounded-[4rem] border border-white/5 shadow-2xl shadow-brand-500/10 max-w-xl w-full">
          ...
          <div className="space-y-3">
            <h2 className="text-4xl font-black text-text-primary tracking-tighter italic">Record Saved!</h2>
            <p className="text-text-tertiary font-bold uppercase tracking-widest text-[10px]">Your monthly entry has been processed by FinSight AI.</p>
          </div>
          <div className="pt-6 flex flex-col sm:flex-row gap-4 justify-center px-4">
            ...
            <Button variant="primary" onClick={() => navigate('/analytics')} className="flex-1 py-4 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 hover:scale-[1.02] text-white font-black shadow-2xl shadow-blue-500/20 transition-all text-xs uppercase tracking-widest">View Analytics</Button>
            <Button variant="primary" onClick={() => navigate('/')} className="flex-1 py-4 rounded-2xl bg-gradient-to-br from-brand-400 to-brand-600 hover:scale-[1.02] text-black font-black shadow-2xl shadow-brand-500/20 transition-all text-xs uppercase tracking-widest">Dashboard</Button>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 relative" ref={formRef}>
      ...
      <header className="relative z-10">
        <h1 className="text-4xl font-black text-text-primary tracking-tighter italic">Ledger Entry.</h1>
