      ...
      <CardContent className="p-10 pt-8 space-y-5">
        {data.tips.map((tip, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`rounded-3xl border ${cfg.border} ${cfg.bg} overflow-hidden transition-all duration-500 cursor-pointer group hover:shadow-lg hover:shadow-black/40`}
            ...
            >
              <div className="flex items-center gap-6 p-6">
                ...
                {/* Expand chevron */}
                <div className={`shrink-0 w-6 h-6 flex items-center justify-center rounded-full border border-white/10 text-text-tertiary transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
